...
<div class="allLand">
            ...
            <?php
                ...
                $data = $db->db_select('post_information','*','Purpose=?',array("House"),'Sn DESC',$a.','.$b);
            ...
            <?php
                ...
                ?>
                    ...
                    <a href="index.php?file=houseing&&type=buy&&a=<?=$back-1?>">&laquo;</a>

                    <?php

                    $db->db_select('post_information','*',"Purpose=? && Status=?",array("House","Published"));
                    ...
                    <a href="index.php?file=houseing&&type=buy&&a=<?=$i?>" class="<?=$active?>"><?=$i?></a>
                    ...
                    <a href="index.php?file=houseing&&type=buy&&a=<?=$back+1?>">&raquo;</a>
...
<div class="sale-area main-container">
    ...
    <h2>Enter your Post Infromation</h2>
    ...
    <br>
                ...
                <label for="">No. of Floor: (<span class="nepali">3/sf] tNnf</span>)</label><br>
                    ...
                    <input type="text" name="Floor" id="" value="<?= Form_data("Floor")?>" required placeholder="No. of Floor">
